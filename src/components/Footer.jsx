    ...
    <footer>
      <div className="container footer-grid">
        <div className="footer-brand">
          ...
          <p>
            Seller account management and web development for businesses
            that want to grow online, without juggling multiple agencies.
          </p>
        ...
        <div className="footer-col">
          <h4>Services</h4>
          <ul>
            <li><a href="#services">Seller Management</a></li>
            <li><a href="#services">Web Development</a></li>
            <li><a href="#">Salon Websites</a></li>
            <li><a href="#">Enterprise Sites</a></li>
          </ul>
        </div>
        ...
        <div className="footer-col">
          ...
          <div className="contact-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M22 6 12 13 2 6" /><rect x="2" y="4" width="20" height="16" rx="2" />
            </svg>
            <span>hello@galoxiq.com</span>
          </div>
          <div className="contact-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
